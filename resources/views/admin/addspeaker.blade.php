                ...
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    ...
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="{{route('add.speaker')}}">Speaker</a></li>
                            <li class="breadcrumb-item active"><a href="#">Add Speaker</a></li>
                        </ol>
                    </div>
            ...
            <div class="col-xl-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="custom-validation" action="{{ route('add.speaker.post') }}" method="POST" enctype='multipart/form-data' id="speakerForm">
                            @csrf
