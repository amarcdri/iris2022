            ...
            <div class="accordion" id="accordionExample">
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header" id="headingeight">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                            ...
                            What will be the constitution of the Steering Committee and Programme
                            Management Unit?
                        </button>
                    </h2>
                    <div id="collapseeight" class="accordion-collapse collapse" aria-labelledby="headingeight"
                        ...
                        <div class="accordion-body">
                            ...
                            recruited from SIDS countries. There will be special provisions made to get
                            external resources onboard to deliver surge or special need activities. The
                            Steering Committee will comprise development and infrastructure policy,
                            governance, and finance experts from SIDS and the donor countries whereas
                            the technical expertise will come from the PMU and CDRI Secretariat.
                ...
                <div class="accordion-item">
                    ...
                    <div id="collapsenine" class="accordion-collapse collapse" aria-labelledby="headingnine"
                        data-bs-parent="#accordionExample">
                        <div class="accordion-body">
                            CDRI’s existing and potential members will contribute to IRIS. A total
                            initial corpus of $50 million is targeted to be mobilized. The funds for
                            IRIS will be made to the CDRI multi-donor trust fund (MDTF), expected to
                            be operational by the end of CDRI’s financial year (March 2022). These
                            funds will be earmarked within the MDTF and will be used for
                            operationalizing IRIS and providing technical support to SIDS. The
                            donors contributing to IRIS will have flexibility in choosing projects,
                            geographical areas, countries, and types of support based on their
                            priorities.
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="headingten">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                ...
                                How will the initial corpus be utilized to address the
                                infrastructure needs of SIDS?
                            </button>
                        </h2>
                        <div id="collapseten" class="accordion-collapse collapse" aria-labelledby="headingten"
                            ...
                            <div class="accordion-body">
                                ...
                                IRIS is a knowledge initiative to ensure that SIDS are better
                                prepared to face future disaster and climate change risks. IRIS will
                                look to build capacities and knowledge for enhancing resilience of
                                infrastructure in SIDS. The purpose of IRIS will not be to construct
                                new infrastructure.
                ...
                <div class="accordion-item">
                    ...
                    <div id="collapsetwentyone" class="accordion-collapse collapse" aria-labelledby="headingtwentyone"
                        data-bs-parent="#accordionExample">
                        <div class="accordion-body">
                            All queries may be directed towards <a href="mailto:iris@cdri.world">iris@cdri.world
