...
<html>
    ...
    <body>
        Dear {{$name}},<br>
        <p>
            This is to confirm that you EoI titled <strong>{{$eoi_project}}</strong> has been successfully submitted under IRIS. The EoI reference number is {{$eoi_no}}. Kindly refer this number for any future enquiry.
